...
class SignerV2 {
    ...
    authenticate(req, res, next) {
        ...
        let maxAllowedSkewMs = this._options.maxAllowedSkewMilliseconds;
        let dateString;
        let date;
        ...
        let authDetails = this.buildAuthorization(headers, method, path, accessKey, secretKey);
    ...
    buildAuthorization(headers, method, path, accessKey, secretKey) {
        let stringToSign = this.buildStringToSign(headers, method, path);
    ...
    buildStringToSign(headers, method, path) {
