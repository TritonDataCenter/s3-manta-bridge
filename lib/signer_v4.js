...
class SignerV4 {
    ...
    _determineSignedPath(requestPath, headers, isBaseEndpoint) {
         ...
         * strip the bucket out of the path. This is needed to support legacy clients. By default,
         * this is disabled. */
        if (this._options.stripBucketPathFromAuth && isBaseEndpoint) {
     ...
     *
     * @private
     * @param {string|Buffer} secretKey secret key to use for signing
